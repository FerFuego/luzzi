...
add_action( 'shopper_homepage', 'shopper_product_categories',    20 );
...
add_action( 'shopper_homepage', 'shopper_recent_products',       60 );
add_action( 'shopper_homepage', 'shopper_on_sale_products',      70 );
